...
Most of these come down to network reality or how lichess serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

lichess rate-limits like any public site. lichess already paces
...
Where a surface is gated, lichess reads a cookie or token you supply
...
`lichess`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what lichess actually did
