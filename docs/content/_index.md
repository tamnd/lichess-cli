---
title: "lichess"
description: "A command line for lichess."
heroTitle: "lichess, from the command line"
heroLead: "A command line for lichess. One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
lichess links <path>           # the pages it links to, each addressable
lichess serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading lichess by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address lichess as
  `lichess://` URIs and follow links across sites. See
