...
// HTTP behaviour is covered in lichess_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "lichess://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("lichess", "about")
	if err != nil || got.String() != "lichess://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want lichess://page/about", got.String(), err)
	}
}
